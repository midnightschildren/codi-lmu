 ...
 */
?>
<div id="sidebar" class="grid-4 s-grid-12 paddedsp s-paddedsp">
  <div>
    <?php 
    ...
    ?>
    <div class="no-widgets"><div id="pages" class="grid-2 alpha">
      <h2>Pages</h2>
      <ul>
        <?php wp_list_pages('title_li='); ?> 
      </ul>
    </div>
    <div id="archives" class="grid-2 omega">
      <h2>Archives</h2>
      <ul>
    ...
    <div class="clear"></div>
    <div id="categories" class="grid-2 alpha">
      <h2>Categories</h2>
      <ul>
        <?php wp_list_categories('show_count=1&title_li='); ?>
      </ul>
    </div>
    <div id="blogroll" class="grid-2 omega">
      <ul>
        <?php wp_list_bookmarks(); ?>
      </ul>
    </div>
    <div class="clear"></div>
    <div id="sidebarmeta" class="grid-2 alpha">
      <h2>Meta</h2>
      <ul>
        <?php wp_register(); ?>
        <li>
    ...
    <div id="feeds" class="grid-2 omega">
      <h2>Feeds</h2>
      <ul>
